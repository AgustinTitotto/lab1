...
<div class="content">
    ...
    <a href="/createinterest" class="btn btn-success" role="button" style="color: #45cb85; font-size: 25px; font-family: LEMON MILK">Create Interest</a>
    <br>
    <br>
    <p>Update your interests</p>
    <a href="/updateinterest" class="btn btn-success" role="button" style="color: #45cb85; font-size: 25px; font-family: LEMON MILK">Update Interests</a>
    <br>
    <br>
    <p>Delete your interests</p>
    <a href="/deleteinterest" class="btn btn-success" role="button" style="color: #45cb85; font-size: 25px; font-family: LEMON MILK">Delete Interests</a>
</div>
